...
<TD align=center class=TableBody1><a href="usermailbox.php?boxname=inbox"><img src=pic/m_inbox.gif border=0 title=收件箱></a> &nbsp; <a href="usermailbox.php?boxname=sendbox"><img src=pic/m_outbox.gif border=0 title=发件箱></a> &nbsp; <a href="usermailbox.php?boxname=deleted"><img src=pic/m_recycle.gif border=0 title=废件箱></a>&nbsp; <a href="friendlist.php"><img src=pic/m_address.gif border=0 title=地址簿></a>&nbsp;<a href="sendmail.php"><img src=pic/m_write.gif border=0 title=发送消息></a></td></tr></TBODY></TABLE>
<?php
}
